...
let /** {String} */ apiUrl = "https://api.github.com/users/brtoz";
  ...
  fetchData(profileUrl, data => {
    ...
    $profileCard.innerHTML = `
      ...
      <a href="${githubPage}" target="_blank" class="btn btn-secondary">
        ...
        <span class="span">Github Profilini Görüntüle</span>
      </a>
      ...
      <ul class="profile-stats">
        ...
        <li class="stats-item">
          <span class="body">${public_repos}</span> Depo
        </li>

        <li class="stats-item">
          <span class="body">${numberToKilo(followers)}</span> Takipçi
        </li>

        <li class="stats-item">
          <span class="body">${numberToKilo(following)}</span> Takip Edilen
        </li>

      </ul>

      <div class="footer">
        <p class="copyright">&copy; 2024 brtoz</p>
      </div>
    `;
